...
const DEPARTAMENTOS = [
     ...
     cuenta, así que van sueltas. */
  {
    ...
    titulo: 'Asistente de WhatsApp con IA para pymes | Marirrodriga IA',
    descripcion: 'Contesta por WhatsApp Business, Telegram o el chat de tu web, mira tu agenda y cierra la cita. Y en tu correo, clasifica y reparte lo que entra. Desde 49 €/mes.',
    ...
    faq: [
      ...
      ['¿Contesta fuera de horario?', 'Sí: las 24 horas, fines de semana incluidos. Lo que no le toca a él —algo que no sabe, un cliente enfadado, una venta con cobro— te lo deja pasado para cuando vuelvas.'],
      ['¿Cuánto cuesta el asistente de WhatsApp Business?', 'Cada pieza lleva su precio y su límite en la tabla de esta página, sin IVA. Lo que Meta cobre por tu cuenta de WhatsApp Business va aparte y a tu nombre: no pasa por nosotros.'],
      ['¿Hay versión gratis?', 'No. Detrás de cada pieza hay un modelo de IA, un servidor y los ajustes que hacemos nosotros, y por eso cada una lleva su cuota con su límite al lado. Lo que sí es gratis es la demo: media hora con tu caso delante y sin compromiso.'],
...
/* ═══ FINANZAS ═══════════════════════════════════════════════════════════ */
{
  ...
  pill: 'Finanzas',
  h1Busqueda: 'Facturación y cobros automáticos para autónomos y pymes',
  titulo: 'Facturación y cobros automáticos para pymes | Marirrodriga IA',
...
/* ═══ LOGÍSTICA ══════════════════════════════════════════════════════════ */
{
  ...
  pill: 'Logística',
  h1Busqueda: 'Seguimiento de pedidos y envíos para empresas y tiendas online',
  titulo: 'Seguimiento de pedidos y envíos con IA | Marirrodriga IA',
...
/* ═══ DATOS Y DIRECCIÓN ══════════════════════════════════════════════════ */
{
  ...
  h1Busqueda: 'Cuadro de mando y análisis de negocio para pymes',
  titulo: 'Cuadro de mando para pymes | Marirrodriga IA',
...
/* ═══ MARKETING ══════════════════════════════════════════════════════════ */
{
  ...
  pill: 'Marketing',
  h1Busqueda: 'Contenido para redes sociales con IA',
  titulo: 'Contenido para redes sociales con IA, para pymes | Marirrodriga IA',
...
/* ═══ POSICIONAMIENTO ONLINE ═════════════════════════════════════════════ */
{
  ...
  h1Busqueda: 'SEO local y reseñas de Google para negocios',
  titulo: 'SEO local, ficha de Google y reseñas para negocios | Marirrodriga IA',
